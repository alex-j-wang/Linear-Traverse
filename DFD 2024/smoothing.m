...
total_force(:, 3) = smooth(total_force(:, 3), length(total_force) / 10);
...
plot(time(1 : phase_width), total_force(:, 3) / Config.W / MAX, 'LineWidth', 1.5, 'DisplayName', string(FC));
