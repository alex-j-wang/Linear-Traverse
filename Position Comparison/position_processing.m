...
for i = 1 : length(filenames)
    ...
    if (A == 0.025 && F == 0.1) || (A == 0.075 && F == 2.8)
        ...
        nexttile;
        Process.format_plot('Example Encoder Signal Fit', 'Time (s)', 'Position (cm)');
        ...
        nexttile;
        Process.format_plot('Example Target Signal Fit', 'Time (s)', 'Position (cm)');
        ...
        nexttile;
        Process.format_plot('Example Measured Signal Fit', 'Time (s)', 'Position (cm)');
        ...
        nexttile;
        Process.format_plot('Example Wave Comparison', 'Time (s)', 'Position (cm)');
